export class ExceptionConstants {
  ...
  public static readonly BadRequestCodes = {
    ...
    TRIAL_EXPIRED: 10017, // The trial period for the resource has expired,
    SUBSCRIPTION_DISABLED: 10018, // The subscription for the resource has been disabled
  };
  ...
  public static readonly InternalServerErrorCodes = {
    ...
    WHATSAPP_CLOUD_API_ERROR: 30007, // Unexpected error occurred in WhatsApp Cloud API
  };
