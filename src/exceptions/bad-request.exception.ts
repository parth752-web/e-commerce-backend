...
export class BadRequestException extends HttpException {
  ...
  static TRIAL_EXPIRED = (msg?: string) => {
    return new BadRequestException({
      message: msg || 'Trial period has expired.',
      code: ExceptionConstants.BadRequestCodes.TRIAL_EXPIRED,
    });
  };

  static SUBSCRIPTION_DISABLED = (msg?: string) => {
    return new BadRequestException({
      message: msg || 'Subscription has been disabled.',
      code: ExceptionConstants.BadRequestCodes.SUBSCRIPTION_DISABLED,
    });
  };
}
