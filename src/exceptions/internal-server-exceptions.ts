...
export class InternalServerErrorException extends HttpException {
   ...
   */
  static INTERNAL_SERVER_ERROR = (error: any, description?: any) => {
   ...
   * @returns A new instance of InternalServerErrorException
   */
  static UNEXPECTED_ERROR = (error: any, description?: any) => {
    return new InternalServerErrorException({
   ...
   * @returns A new instance of InternalServerErrorException
   */
  static WHATSAPP_CLOUD_API_ERROR = (error: any) => {
    return new InternalServerErrorException({
      message: 'An unexpected error occurred while communicating with the WhatsApp Cloud API.',
      code: ExceptionConstants.InternalServerErrorCodes.WHATSAPP_CLOUD_API_ERROR,
      cause: error,
    });
  };
}
